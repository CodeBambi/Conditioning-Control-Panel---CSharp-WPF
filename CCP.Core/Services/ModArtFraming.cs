...
namespace ConditioningControlPanel.Services
{
    ...
    public static class ModArtFramingRegistry
    {
        ...
        private static readonly ArtSlotBinding[] _bindings =
        {
            ...
            new("features/blink_trainer.png",  SurfaceRailChip, new ArtViewbox(0.05, 0.06, 0.44, 0.72)),
            new("lockdown_icon.png",           SurfaceRailChip, new ArtViewbox(0.08, 0,    0.25, 1)),
            ...
            new("achievements/honor_roll.png",   SurfaceRailChip, new ArtViewbox(0.06, 0.03, 0.88, 0.58)),
            new("achievements/teachers_pet.png", SurfaceRailChip, new ArtViewbox(0.06, 0.03, 0.88, 0.58)),
            new("achievements/modder.png",       SurfaceRailChip, new ArtViewbox(0.06, 0.03, 0.88, 0.58)),
            new("achievements/curator.png",      SurfaceRailChip, new ArtViewbox(0.06, 0.03, 0.88, 0.58)),
            new("achievements/word_perfect.png", SurfaceRailChip, new ArtViewbox(0.06, 0.03, 0.88, 0.58)),
            new("achievements/screen_time.png",  SurfaceRailChip, new ArtViewbox(0.06, 0.03, 0.88, 0.58)),
            new("quests/daily_devotion_d.png",   SurfaceRailChip, new ArtViewbox(0.05, 0.04, 0.90, 0.68)),
            new("skills/hive_mind.png",          SurfaceRailChip, new ArtViewbox(0.04, 0.06, 0.72, 0.66)),
            new("skills/sparkle_boost_3.png",    SurfaceRailChip, new ArtViewbox(0.04, 0.06, 0.66, 0.70)),
            new("skills/trophy_case.png",        SurfaceRailChip, new ArtViewbox(0.10, 0.06, 0.60, 0.70)),
            new("skills/lucky_bubbles.png",      SurfaceRailChip, new ArtViewbox(0.06, 0.06, 0.88, 0.70)),
            ...
            new("programs/plate_default.png",    SurfaceRailChip, new ArtViewbox(0, 0, 1, 1)),
            new("Cards/spotlight.png",           SurfaceRailChip, new ArtViewbox(0, 0, 1, 1)),
