...
namespace ConditioningControlPanel.Services.Moderation
{
    ...
    public sealed class ModerationLog
    {
        ...
        {
            _session = session;
            // CorePaths.UserData is %LOCALAPPDATA%/ConditioningControlPanel (and honours the
            // CCP_USERDATA_DIR override); App.UserDataPath forwards to it. This used to hand-roll the path off
            ...
            _logDir = Path.Combine(CorePaths.UserData, "logs");
