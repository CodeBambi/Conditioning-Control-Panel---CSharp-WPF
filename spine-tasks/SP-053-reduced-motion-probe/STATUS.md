...
**Current Step:** Step 1 — probe design + pre-approach consult
**Last Updated:** 2026-08-05 (authored)
**Blockers:** none

### Step 1: probe design + pre-approach consult
- [ ] Update STATUS.md before starting work
- [ ] Measurement design (page-side probe + host OS read + toggle mechanism + restore)
- [ ] Failure-contingent mechanism sketch (built only if inheritance fails)
