...
- [ ] Unit tests (round-trip INTO prompt; read-gating; ambient stateless; enrichment exclusion; trimming)

### Step 3: surface honesty + evidence + pre-completion consult
- [ ] Non-claim line updated to the true state (typed-default-honest)
- [ ] Offline zero-network + content-free diagnostics
- [ ] record.md (archaeology, design, consults, review presence)
