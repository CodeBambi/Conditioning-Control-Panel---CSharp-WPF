...
| SP-013-popup-scrolling | Row: prove feature-popup scrolling (builds the popup SP-007 carved out) | Authored 2026-07-20 (pre-authoring Fable consult applied: demonstrator frame, popup-local chrome only — no shared chrome/A-005 trap, tall/short/nested-chaining content, touch probe-don't-promise, Extent/Viewport/Offset evidence required, W-04 discharge NOT claimed) | SP-012 |
