...
- [ ] `client/CcpClient.sln` + desktop app project (Avalonia 12.1.0, net10.0) + `client/tests/CcpClient.Tests` created
- [ ] Restore + Debug build succeed with 0 warnings
- [ ] Composition-root shape instantiated minimally (no features)
