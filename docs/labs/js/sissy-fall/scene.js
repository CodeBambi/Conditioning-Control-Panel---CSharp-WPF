...
import { Q, setQuality } from '../rabbit-hole/quality.js';
import { createFog } from '../rabbit-hole/fog.js';
import { isMuted, toggleMuted, onMuteChange } from '../rabbit-hole/audioMute.js';
import { disposeTextures } from '../rabbit-hole/assets.js';
...
const DRONE_URL = '../../assets/audio/drone1.mp3'; // Explore uses drift-under-glass; the fall gets its own bed
