...
try {
    ...
    foreach ($entry in @(@('CCP.Avalonia', '45db01c7acbdf6aa5cb016dd218ddff3513f16ac'), @('CCP.Core', 'ec2d4c2a60bf3683ce7ec97c4d9e1c5c6d84b0c3'))) {
    ...
    foreach ($mode in 'red', 'green') {
        ...
        if ($testHash -ne 'a55d7ab586f43ad1110f0bf15c9269be7e13681672a09fd3f7d172e8fd2b20ef') { throw 'Test bytes changed' }
