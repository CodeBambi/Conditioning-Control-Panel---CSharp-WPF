...
{
    public partial class BouncingTextFeatureControl : UserControl, ISettingsRebindable
    {
        ...
        /// </summary>
        private const string FeatureArtPath = "features/bouncing_text.png";
        ...
        private void ApplyFeatureArt()
        {
            ...
            {
                App.Logger?.Debug("BouncingTextFeatureControl.ApplyFeatureArt: {E}", ex.Message);
            }
        }
