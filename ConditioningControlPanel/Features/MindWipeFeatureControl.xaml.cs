...
{
    public partial class MindWipeFeatureControl : UserControl, ISettingsRebindable
    {
        ...
        /// </summary>
        private const string FeatureArtPath = "features/Mind_Wipers.png";
        ...
        private void ApplyFeatureArt()
        {
            ...
            {
                App.Logger?.Debug("MindWipeFeatureControl.ApplyFeatureArt: {E}", ex.Message);
            }
        }
