...
internal static class Program
{
    ...
    private static readonly string OutputDir = Path.Combine(
        ...
        // Six levels: bin/<cfg>/<tfm> then GenerateAwarenessSounds/tools/ConditioningControlPanel,
        // which is the repo root. main's sixth level came from the tool moving under
        // ConditioningControlPanel/tools; the tail is the shared /Assets root this port uses.
        "..", "..", "..", "..", "..", "..",
        "Assets", "AwarenessPresets", "audio");
