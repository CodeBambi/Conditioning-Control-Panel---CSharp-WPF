...
eq(constOf('TEX_PX'), 128, 'each one 128 px square');
eq(constOf('TEXT_FRAC'), 0.7, 'and the word fits inside 70 percent of the diameter');
eq(constOf('MAX_LINES'), 2, 'over at most two lines');
eq(constOf('OUTLINE_PX'), 2, 'with a 2 px dark outline so it reads on the bubble highlight');
