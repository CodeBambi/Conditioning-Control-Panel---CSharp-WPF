...
export const BOONS = [
  ...
  { id: 'racing_thoughts', name: 'Racing Thoughts', rarity: 'Rare', curse: false, mult: 0.0, unique: true,
    requiresAny: ['intrusive_thoughts', 'porn_dvd'],
    desc: 'the thoughts blow up BIGGER, race FASTER, and won\'t leave: bouncing text is 1.5x larger, 1.4x quicker, and lingers 60% longer.',
    flavor: 'louder every time it comes back around.',
    apply: (s) => { s.dvdScaleMult = 1.5; s.dvdSpeedMult = 1.4; s.dvdLifeMult = 1.6; } },
  { id: 'short_circuit', name: 'Short Circuit', rarity: 'Rare', curse: false, mult: 0.0, unique: true, fxTheme: 'electric',
    requiresAll: ['e_stim'], requiresAny: ['porn_dvd', 'intrusive_thoughts'],
    desc: 'the broadcast shorts out: the bouncing logo crackles with static and arcs lightning into the field on every bounce, feeding the E-Stim chain.',
    flavor: 'the signal was live the whole time.',
    apply: (s) => { s.dvdElectrified = true; } },
  ...
  { id: 'riptide', name: 'Riptide', rarity: 'Rare', curse: false, mult: 0.0, unique: true, fxTheme: 'rabbit',
    requiresAny: ['the_spanker', 'rabbit_caller', 'the_pull'],
    desc: 'your ripple grabs every rabbit the wave washes over - flinging it off faster, dragging a sparkling wake for 2s.',
    flavor: 'the undertow always finds them.',
    apply: (s) => { s.rippleFlingsRabbits = true; } },
