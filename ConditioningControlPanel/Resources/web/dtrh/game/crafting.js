 ...
 *
 * Part 1 ships the loop with STUB effects: every `effect` is null and crafted
 * items sit "dormant" in KEPT THINGS. Part 2 wires real effects (and re-audits
 * the consumable/permanent split).
 * ==========================================================================*/
...
export const RECIPES = [
  { id: 'slippery_slope', name: 'Slippery Slope', glyph: '💨', grid: 'O../.O./..O',
    ...
    flavor: 'the first step was the hard one. the rest is geometry.', effect: null },
  { id: 'rubber_up', name: 'Rubber Up', glyph: '🛡', grid: 'SSS/S.S/...',
    resultKind: 'consumable',
    desc: 'a silicone dome to hide under. one run, one extra mistake forgiven.',
    flavor: 'protection. how responsible of you.', effect: null },
  { id: 'skeleton_key', name: 'Skeleton Key', glyph: '🗝', grid: '.C./.C./.CO',
    ...
    flavor: 'it doesn’t open every door. just the ones you keep staring at.', effect: null },
  ...
  { id: 'the_ballerina', name: 'The Ballerina', glyph: '🩰', grid: '.M./.L./CCC',
    ...
    flavor: 'wind her up and she spins. sound familiar?', effect: null },
  { id: 'the_compact', name: 'The Compact', glyph: '🪞', grid: 'CCC/CMC/CCC',
    ...
    flavor: 'a little mirror that remembers everything you did down there.', effect: null },
  { id: 'the_loom', name: 'The Loom', glyph: '🌀', grid: 'MM./.M./.MM',
    ...
    flavor: 'you drew the spiral yourself. remember that, later, when it draws you.', effect: null },
  ...
  { id: 'lipstick', name: 'Lipstick', glyph: '💋', grid: '.M./.C./.C.',
    ...
    flavor: 'the tip defines the object. the shade defines you.', effect: null },
  { id: 'the_hourglass', name: 'The Hourglass', glyph: '⌛', grid: 'CCC/.P./CCC',
    ...
    flavor: 'time didn’t stop. it’s just holding its breath for you.', effect: null },
  { id: 'the_timepiece', name: 'The Timepiece', glyph: '⏱', grid: 'CCC/CPC/CCC',
    ...
    flavor: 'tick. tock. slower now. you can savour it.', effect: null },
  { id: 'the_ring_box', name: 'The Ring Box', glyph: '💍', grid: 'CCC/CLC/CCC',
    ...
    flavor: 'she keeps your favourite arrangements. she noticed you have favourites.', effect: null },
  { id: 'the_corset', name: 'The Corset', glyph: '👗', grid: 'L.L/.L./L.L',
    resultKind: 'permanent',
    desc: 'lace crossed tight in an X. holds you together - +1 max resistance.',
    flavor: 'it doesn’t squeeze. it reminds.', effect: null },
  { id: 'sugar_cube', name: 'Sugar Cube', glyph: '🍬', grid: 'PP./PP./...',
    ...
    flavor: 'he can smell it. he pretends he can’t. he comes anyway.', effect: null },
  { id: 'the_shot', name: 'The Shot', glyph: '💉', grid: '.P./.S./.C.',
    ...
    flavor: 'just a little pinch. it barely even stings anymore.', effect: null },
  { id: 'headphones', name: 'Headphones', glyph: '🎧', grid: 'CCC/S.S/...',
    ...
    flavor: 'noise cancelling. the noise being your own opinion.', effect: null },
  { id: 'the_padlock', name: 'The Padlock', glyph: '🔐', grid: 'C.C/CCC/CCC',
    ...
    flavor: 'commitment, in hardware form.', effect: null },
