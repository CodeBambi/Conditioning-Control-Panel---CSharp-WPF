...
// ================================================= 8. boot wiring, at its call site
{
  ...
  ok(/localCapsOf\(\{ elements, payloads, rounds, platform: 'web', voice: voiceCap, (?:night: NIGHT_CAP_VERSION, )?(?:score: SCORE_CAP_VERSION, )?transfer: (?:true|transferCap) \}\)/.test(boot),
