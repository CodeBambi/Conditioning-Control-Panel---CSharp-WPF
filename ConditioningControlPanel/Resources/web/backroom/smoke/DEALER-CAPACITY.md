...
Owner mobile revision: runtime faces are 2.25 times the authored card size. layout-3d.js centers the current hands from the authored dealer origin and dimensions, separates two dealer rows from the player row, and shares every position with the camera fitter. The twelve/six/six capacity and owner/slot mapping stay unchanged.
