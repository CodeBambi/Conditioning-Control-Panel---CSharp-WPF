...
export function createDoubleCharm({mount,lex,read,now=()=>Date.now()}){
  ...
  style.textContent='.br-double-charm{margin-left:8px;border:1px solid #e8c27a;border-radius:20px;background:#392142;color:#ffe0a0;font:700 12px Segoe UI;min-width:34px;min-height:30px;pointer-events:auto}.br-double-note{position:fixed;right:12px;top:108px;max-width:min(310px,calc(100vw - 24px));padding:12px;border:1px solid #e8c27a;border-radius:10px;background:#23122ff5;color:#efdfef;z-index:80;font:12px/1.5 Segoe UI;pointer-events:auto}.br-double-charm[hidden],.br-double-note[hidden]{display:none}body:has(.br-double-charm:not([hidden])) .br-nav,body:has(.br-double-charm:not([hidden])) .br-bell{right:180px}@media(max-width:600px){body:has(.br-double-charm:not([hidden])) .br-nav{top:58px;left:12px;right:12px;justify-content:flex-end}body:has(.br-double-charm:not([hidden])) .br-bell{top:98px;right:12px;max-width:calc(100vw - 24px)}}';
