...
export const WORD_BRICK_P = 1 / 8;   // Grey World noise dial.
...
export const MOD_DEFAULTS = Object.freeze({ timeScale: 1, paddleW: 1, ballSpeed: 1, safe: false, shield: false, autopilot: false, hideBricks: 0, zoom: 1 });
