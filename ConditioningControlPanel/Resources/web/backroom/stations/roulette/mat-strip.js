// Interim bet strip for the seated bowl. The authored 3D mat replaces this view.
export function createMatStrip({ root, spots, label, place }) {
  ...
  for (const spot of spots) {
    ...
    button.onclick = e => place(spot, e.shiftKey);
  ...
  return { layout() {}, hit() { return null; }, rectOf,
