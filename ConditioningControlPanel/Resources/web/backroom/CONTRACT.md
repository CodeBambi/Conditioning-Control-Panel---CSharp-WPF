...
- THE ALMOST (A1 + A2, 10.14): a live pair on reels 1 and 2 holds reel 3 (900-1,400 ms, halved while melted), and a
  no-pay spin one cell off the line ghosts that cell gold and snaps back once. The tape already holds the outcome.
- THE BANK, proportional (A3, 10.14): the count-up is sized to the win (500 ms to about 6 s), the chime ladder
  climbs with it, one press settles it at once (Law VI, Brake 7).
- Law VIII (A4, 10.14): attract mode drifts after 25 s seated idle and any press ends it inside 100 ms. No SP moves.
- THE MASCOT GLANCE (A5, 10.14): EMI wiggles wherever she lands, after that reel's thud, and glances.
- Law IX (A6, 10.14): a win frames its own row and the frame pulses for the length of the rollup.
...
shows them still.
## 10.14 Playbook Tier A amendment (2026-09-14)
