...
1. **Row acceptance = BEHAVIOR PARITY (or a documented improvement) AND the perf gate.** A row is at
   ...
   startup ~2.5s vs ~4.2s; working set ~422MB vs ~1218MB; Chaos AvgFps 138.7 ≫ 30 floor.
