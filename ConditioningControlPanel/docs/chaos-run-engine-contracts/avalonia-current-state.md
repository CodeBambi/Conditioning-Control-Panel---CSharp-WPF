...
**The docs' "6 unwired passives"** = the NOT-YET-MIGRATED window overlays (UCE plan :194-200 queue rows #9-14): `ChaosEStimGlowOverlay` (184L), `ChaosEStimOverlay` (267L), `ChaosWaveTimerOverlay` (243L), `ChaosVibeTrailOverlay` (300L), `ChaosFxWindow` (172L), `ChaosSkiaFxOverlay` (632L — WPF default glow renderer, `ChaosSkiaFxEnabled ?? true`). Port obligations: (a) production callers for the already-migrated 8 (esp. PopText + FieldFx), (b) migrate + wire the 6 windows.
