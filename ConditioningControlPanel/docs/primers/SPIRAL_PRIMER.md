...
| `CCP.Core/Services/Compositor/CompositorLayers.cs` | Z-order constants. **`Spiral = 60`** (`:18`) — between `BrainDrain = 55` and `PinkTint = 70`. Numbers are shared with the Avalonia port; don't renumber unilaterally. |
