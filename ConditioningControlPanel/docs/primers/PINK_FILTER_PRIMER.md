...
| `CCP.Core/Services/Compositor/CompositorLayers.cs:19` | `PinkTint = 70` — the authoritative z-index (above Spiral 60, BrainDrain 55; below the chaos band 100+). Kept in sync with the Avalonia port — don't renumber unilaterally. |
