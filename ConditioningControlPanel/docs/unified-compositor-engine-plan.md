...
| Chaos overlays | ⚠️ migration UNDERWAY (WS2/WP3): `ChaosCursorGlowLayer` (Z=130, the template) + `ChaosEffectBannerLayer` (Z=140) + `ChaosPopTextLayer` (Z=145) + `ChaosAnnouncerLayer` (Z=150) harness-verified 2026-07-04; queue + recipe in Phase F below |
