...
| **AI-6** command param threading | medium/M | flash Amount/Duration/Size/Opacity, subliminal Opacity(0-60), bubbles Frequency(0-10) dropped | AiCommandService ExecuteCore per-type cases |
