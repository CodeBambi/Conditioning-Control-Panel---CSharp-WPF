...
> **BARK-3 (follow-up, small):** whisper-overtalk gate — add a whisper/subliminal-audio-playing seam and wire IBarkGateSignals.IsWhisperAudioPlaying so live barks don't talk over subliminal whisper audio (port has no whisper-audio flag today; narrator moot = DTRH web-only).
