...
internal static class ConversationPrompt
{
        ...
        bool localEffects, IEnumerable<string>? titles = null, bool preserveOutputRules = true)
    {
        ...
        text.AppendLine("CAPABILITIES: Never invent recent browsing, pictures found, or actions outside the supplied context. You can chat and use the conversation and supplied memory. You cannot browse the web, see the screen unless context is supplied, change settings, award XP, or save a memory merely by saying you did.");
