        ...
        private static readonly Dictionary<string, HelpContent> _content = new()
        {
            ...
            ["Unlockables"] = new HelpContent
            {
                ...
                Tips = new List<string>
                {
                    ...
                    "**Sparkle Points** come from **levelling up** and from every **100 bubbles** popped"
                },
            ...
            ["BubblePop"] = new HelpContent
            {
                ...
                Tips = new List<string>
                {
                    ...
                    "Every **100 bubbles** you pop mints **1 Sparkle Point** for the skill tree and the Back Room",
