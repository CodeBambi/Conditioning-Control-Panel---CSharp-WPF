...
// BackRoomFxIntensity moved to CCP.Core/Services/BackRoom/BackRoomFxIntensity.cs: AppSettings
// persists it and settings live in Core. Same namespace, so nothing here changes.
