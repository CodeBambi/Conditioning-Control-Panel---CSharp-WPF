...
public class EmiLockerOutfitTests
{
    ...
    public void The_desk_and_the_locker_gate_the_same_four_prizes()
    {
        ...
        // Web assets are shared bytes at the repo-root /Assets tree, not under the head.
        var locker = File.ReadAllText(Path.Combine(
            RepoRoot(), "Assets", "web", "arcademy", "shell", "locker.js"));
