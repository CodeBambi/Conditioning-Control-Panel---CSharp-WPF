...
You audit uncommitted greenfield changes under `client/` in this repository. READ-ONLY. Never edit files, commit, stash, or modify the WPF/first-attempt trees. Paths are repository-relative; the checkout path differs per machine.
