...
|---|---|---|
| `Effects/FlashSurfacePresenter.cs:338` | 1, 2, 3, 4 | one decay ladder AND one luminance layer per placed image |
...
| site | decision | quote |
|---|---|---|
| 5 | `Effects/FlashSurfacePresenter.cs:334` | `serve pop / hydra / XP mechanics this port does not have` |
...
`ClickThrough: true` unconditionally (`Effects/FlashSurfacePresenter.cs:337`): a surface that caught
