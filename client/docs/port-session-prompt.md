...
3. **Validate before launching:** every packet parses, its contract row is present, its File Scope is disjoint from every other packet in the wave, and no packet includes `client/docs/task-board.md` in a parallel wave.
