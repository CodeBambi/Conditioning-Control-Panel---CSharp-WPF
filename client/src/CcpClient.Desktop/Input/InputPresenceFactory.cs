...
public static class InputPresenceFactory
{
    ...
    public const string LinuxManualGate =
        ...
        + "(4) a pointer hit test at a point inside the card resolves to the card (X11: `xdotool "
        + "getmouselocation` in its shell-variable form, while the pointer is over it); "
