...
/// (<c>CCP.Core/Models/AppSettings.cs:2670-2705</c>).
///
...
public sealed class SpiralPresetDocument
{
    ...
    /// <summary>WPF default (<c>AppSettings.cs:2698</c>): 10 %.</summary>
    public const int DefaultOpacityPercent = 10;

    /// <summary>WPF clamp <c>Math.Clamp(value, 0, 100)</c> (<c>AppSettings.cs:2702</c>). <b>Zero is
    ...
    /// <summary>WPF clamp <c>Math.Clamp(value, 0, 100)</c> (<c>AppSettings.cs:2702</c>). The ceiling
    ...
    /// <summary>
    /// WPF's <c>SpiralOpacity</c> (<c>AppSettings.cs:2698-2703</c>): the dial in percent, default
    ...
    /// <summary>
    /// WPF's <c>SpiralPath</c> (<c>AppSettings.cs:2679-2684</c>): the user's chosen spiral file,
